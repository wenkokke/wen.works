...
Now, it just so happens that the first search result for "Turing machine example program" on the day I wrote this post was a machine which increments binary numbers, and its table looked like this:[^sn-turing-machine-source]

![Transition function for a Turing machine which computes the binary successor.](../assets/images/bit-succ-tm.png)
...
[^sn-turing-machine-source]: Taken from <https://www.cl.cam.ac.uk/projects/raspberrypi/tutorials/turing-machine/four.html>
