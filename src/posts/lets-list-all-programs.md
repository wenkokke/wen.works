...
{-# SPECIALISE
  inferUsageTyTm ::
    (Fin ty, Fin tm) =>
    Proxy Rel -> Tm ty tm -> (Cool, Rel tm)
  #-}
```
-->
...
checkClosedRelTyRelTm e t =
  checkClosedTm e t
  &&&
  fst (inferUsageTyTm @Rel @Rel (Proxy @Rel) e)
```
...
<!--
NOTE: This is all relevant terms, for good measure.
...
<!--
NOTE: This is an alternative strategy for checking usage.
      It sequentially checks the term from left to right.
      As shown by benchmarks, this strategy is less efficient.
...
<!--
NOTE: This is an alternative strategy for checking usage.
      It more closely resembles a sensible type system.
      However, is shown by tests, it is likely equivalent.
...
<!--
NOTE: This is the alternative strategy instatiated to linearity checking.
...
<!--
NOTE: This is a property based test that tests the equivalence between,
      the straightforward and the more sensible strategy.
...
<!--
NOTE: This is relevant typing for simply-typed terms, for good measure.
...
<!--
NOTE: This is sequental checking for relevant typing for simply-typed terms.
...
<!--
NOTE: This is the unrestricted multiplicity.
...
<!--
NOTE: This checks equivalence between term-only linearity chekcing,
      and term-and-type linearity checking, with the type-level check
      instantiated to Un.
...
<!--
NOTE: This checks equivalence between term-only relevance chekcing,
      and term-and-type relevance checking, with the type-level check
      instantiated to Un.
